...
@implementation NSFileManagerAES

NSFileManagerAES *g_fileManagerAES;

+ (NSFileManagerAES *)defaultManager
{
    if (nil == g_fileManagerAES) 
    {
        g_fileManagerAES = [[NSFileManagerAES alloc] init];
    }
    
    return g_fileManagerAES;
}
